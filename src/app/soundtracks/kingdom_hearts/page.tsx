    ...
    return (
        <div className="py-15 pb-30 px-10 md:px-20 text-[18px] md:text-[20px]">
            ...
            <div className="flex flex-col gap-4 pt-7">
                ...
                <SmartLink text="Spotify" type="spotify" url="https://open.spotify.com/album/59xa0duBH2doywRKohAqIY?si=zXfN1fGqQjOlV67yslYIvg" />
                <SmartLink text="Apple Music" type="applemusic" url="https://music.apple.com/gb/album/kingdom-hearts-hd-1-5-remix-original-soundtrack/1670071081" />
            </div>
        </div>
    );
}